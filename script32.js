...
function applyLanguage() {
  ...
  if (currentLang === "ar") {
    ...
    document.querySelector("#maintenanceLogBtn span").textContent = "Maintenance Log";
...
function showMaintenanceLog() {
  const title = currentLang === "ar" ? "سجل الصيانة" : "Maintenance Log";
  const content =
    currentLang === "ar"
      ? "<p>هنا يمكن ربط أو عرض سجل الصيانة التفصيلي من النظام أو ملف خارجي.</p>"
      : "<p>Here you can link or display the detailed maintenance log from the system or an external file.</p>";
